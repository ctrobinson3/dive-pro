export function diveArrayFunction() {
    ...
    //Twister
    //T-Forward
    const t5111a = new Dive('Forward', 'Dive, 1/2 Twist', 'Straight', '1.8', 5, 5111);
    const t5111b = new Dive('Forward', 'Dive, 1/2 Twist', 'Pike', '1.7', 5, 5111);
    const t5111c = new Dive('Forward', 'Dive, 1/2 Twist', 'Tuck', '1.6', 5, 5111);
    const t5112a = new Dive('Forward', 'Dive, 1 Twist', 'Straight', '2.0', 5, 5112);
    ...
    const t5131d = new Dive('Forward', '1.5 SS, 1/2 Twist', 'Free', '2.0', 5, 5131);
    const t5132d = new Dive('Forward', '1.5 SS, 1 Twist', 'Free', '2.2', 5, 5132);
    const t5134d = new Dive('Forward', '1.5 SS, 2 Twists', 'Free', '2.6', 5, 5134);
    ...
    //T-Back
    const t5211a = new Dive('Back', 'Dive, 1/2 Twist', 'Straight', '1.8', 5, 5211);
    ...
    //T-Reverse
    const t5311a = new Dive('Reverse', 'Dive, 1/2 Twist', 'Straight', '1.9', 5, 5311);
    const t5312a = new Dive('Reverse', 'Dive, 1 Twist', 'Straight', '2.1', 5, 5312);
    ...
    const t5331d = new Dive('Reverse', '1.5 SS, 1/2 Twist', 'Free', '2.2', 5, 5331);
    const t5333d = new Dive('Reverse', '1.5 SS, 1.5 Twist', 'Free', '2.6', 5, 5333);
    const t5335d = new Dive('Reverse', '1.5 SS, 2.5 Twist', 'Free', '3.0', 5, 5335);
    const t5351b = new Dive('Reverse', '2.5 SS, 1/2 Twist', 'Pike', '2.9', 5, 5351);
    const t5351c = new Dive('Reverse', '2.5 SS, 1/2 Twist', 'Tuck', '2.7', 5, 5351);
    //T-Inward
    const t5411a = new Dive('Inward', 'Dive, 1/2 Twist', 'Straight', '2.0', 5, 5411);
    const t5411b = new Dive('Inward', 'Dive, 1/2 Twist', 'Pike', '1.7', 5, 5411);
    const t5412a = new Dive('Inward', 'Dive, 1 Twist', 'Straight', '2.2', 5, 5412);
    ...
    return [
        ...
        f112b, f112c, f113b, f113c,
        b201a, b201b, b201c, b202a, b202b, b202c, b203a, b203b, b203c, b204b, b204c, b205b, b205c,
        r301a, r301b, r301c, r302a, r302b, r302c, r303a, r303b, r303c, r304a, r304b, r304c, r305b, r305c,
        i401a, i401b, i401c, i402a, i402b, i402c, i403b, i403c, i404b, i404c, i405b, i405c,
        i412b, i412c, i413b, i413c,
